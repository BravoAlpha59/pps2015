...
In general, I'd say: don't try to write this paper in order. Start in the middle, writing up some experimental results, or describing the problem we're working with here - whatever seems clearest to you. As you go, it'll become more clear what the intro, abstract, and conclusion should say.

Also, don't get stuck on LaTeX! I'm no expert, but I've generally eventually figured out what I need, so please ask me if you're having trouble with something.

\section{Related Work}\label{sec:related}

Perspective here - what papers informed the things we've done? How does our work fit into this context?
...
Describe the experiments precisely, show graphs, tables, etc. as appropriate. Text accompanies these figures, describing notable results. But not trying to explain them here!
...
We saw slightly improved scores through the use of the early hard coded moves, as they allowed more time to be divided between subsequent moves. Hard coding of the final two moves allowed us to create a time buffer in order to ensure that the player would not exceed the 30 second time limit
