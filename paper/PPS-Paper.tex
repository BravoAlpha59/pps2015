...
% RTA commented for removal, added in later experimental data section
%$C_p$ is the constant in exploration and can be increased or decreased to produce more or less exploration, respectively. ~\cite{kocsis2006improved} suggest that $C_p = \frac{1}{\sqrt{2}}$ is ideal when rewards range in $[0,1]$, but otherwise there are few definitive conclusions on setting this constant.
%
